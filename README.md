# boms237 - Plateforme Web E-commerce

Bienvenue sur le dépôt du code source de l'application web **boms237**. Ce projet est une solution complète (Site Vitrine + E-commerce + Administration) développée avec des technologies modernes pour assurer performance et évolutivité.
...
| :--- | :--- | :--- | :--- |
| **Administrateur** | `admin@boms237.cm` | `admin123` | **OTP : 2025** |
| **Utilisateur** | `user@boms237.cm` | `user123` | |
